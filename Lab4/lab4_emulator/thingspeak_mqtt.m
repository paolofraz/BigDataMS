...
% Publish
message = strcat('field1=',num2str(f1),"&field2=",num2str(f2),"&field3=",num2str(f3));
myMQTT = mqtt('tcp://mqtt.thingspeak.com')
publish(myMQTT,'channels/1058393/publish/TN9YI0LXPW61CYSD',message)